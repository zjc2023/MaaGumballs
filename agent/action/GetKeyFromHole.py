...
# distance:  240 roi:  [[435, 575, 60, 45], [195, 575, 60, 45]]
    ...
    def run(
        ...
        while now_leftstring < leftstringstart + distance:
            ...
            # 移动按钮
            context.tasker.controller.post_swipe(button_x, button_y, button_x + step, button_y, 100)
            now_leftstring = context.run_task("FindLeftString").nodes[0].recognition.box.x
